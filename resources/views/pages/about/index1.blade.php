            ...
            <div class="col-md-10 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @if (Auth::user()->can('user view') || Auth::user()->role->id == 1)<a href="{{ route('users.index') }}"
                    class="btn btn-info">Back</a>@endif
                    </span> --}}
                    </div>
                    <div class="card-body">
                        <div class="row">
            ...
            <div class="col-md-10 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        {{-- <span class="float-right">
                    @if (Auth::user()->can('add blood-group') || Auth::user()->role->id == 1)<a href="{{ route('bloodgroup.create') }}"
                    class="btn btn-info">Add new Blood Group</a>@endif
                    </span> --}}
                    </div>
                    <div class="card-body">
                            ...
                            <table id="table" class="">
                                ...
                                <td class="text-middle py-0 align-middle">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ route('bloodgroup.edit', $d->id) }}" class="btn btn-dark btnEdit"><i
                                                class="fas fa-edit"></i></a>
                                        @endif
                                        @if (Auth::user()->can('delete blood-group') || Auth::user()->role->id == 1)
                                        <a href="{{ route('bloodgroup.destroy', $d->id) }}"
...
@push('page_scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            // $(".about_class").on('click', function(e) {
            //     e.preventDefault()
